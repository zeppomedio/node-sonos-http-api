...
function googlePlay(player, values) {
    ...
    checkAuth().then(function() {
        ...
        return playSearcher(type, searchTerm);
...
function buildCredentialsXML() {
    var soap = SOAP.Credentials.format({
        ...
        token: Config.token,
        key: Config.key,
        householdId: 'Sonos_JpRt9G7QxxkS5NFnhf2hcPoPBZ'
    })
    return soap;
}
...
setTimeout(function() {
    ...
    //googlePlay(office, ["track", "get back let it be naked"]);
}, 1000);
*/